...
import { MainModalContainer, MainModalOverlayContainer, MainModalContentContainer, MainModalHeaderContainer, MainModalBodyContainer } from './styles';

const MainModal = (props) => {

  return (
    <MainModalContainer>
      <MainModalOverlayContainer onClick={props.handleClose}></MainModalOverlayContainer>
